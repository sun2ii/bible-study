...
**Key Greek:**
- τετράρχης (tetrarchēs) — "tetrarch, ruler of fourth"
- συνείδησις (syneidēsis) — "conscience, awareness"
...
**Key Greek:**
- σπλαγχνίζομαι (splanchnizomai) — "to have compassion, moved in gut"
- εὐλογέω (eulogeō) — "to bless, give thanks"
- κλάω (klaō) — "to break"
...
**Key Greek:**
- περιπατέω (peripateō) — "to walk around"
- ὀλιγόπιστος (oligopistos) — "little faith, weak belief"
- διστάζω (distazō) — "to doubt, waver"
...
**Key Greek:**
- διασῴζω (diasōzō) — "to bring safely through, heal completely"
- κράσπεδον (kraspedon) — "edge, fringe, tassel"
