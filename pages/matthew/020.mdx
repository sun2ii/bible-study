...
**Key Greek:**
- δηνάριον (dēnarion) — "denarius" (day's wage)
- ἐργάτης (ergatēs) — "worker, laborer"
- πονηρός (ponēros) — "evil, envious" (lit. "evil eye")
- ἀγαθός (agathos) — "good, generous"
...
**Key Greek:**
- παραδίδωμι (paradidōmi) — "to deliver over, betray, hand over"
- ἐμπαίζω (empaizō) — "to mock, ridicule"
- μαστιγόω (mastigoō) — "to flog, scourge"
...
**Key Greek:**
- δεξιός (dexios) — "right hand" (position of honor)
- εὐώνυμος (euōnymos) — "left hand" (second position)
- ποτήριον (potērion) — "cup" (of suffering)
