...
- σκηνή (skēnē) — "tent, tabernacle, shelter"
- ἀκούω (akouō) — "to hear, listen, obey"
...
**Key Greek:**
- ὀλιγοπιστία (oligopistia) — "little faith"
- κόκκον σινάπεως (kokkon sinapeōs) — "grain of mustard seed"
...
**Key Greek:**
- παραδίδοσθαι (paradidosthai) — "to be handed over, betrayed, delivered"
...
**Key Greek:**
- δίδραχμον (didrachmon) — "two-drachma coin" (half-shekel)
- στατήρ (statēr) — "four-drachma coin" (full shekel)
