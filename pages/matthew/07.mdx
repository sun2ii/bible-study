...
**Key Greek:** κρίνω (krinō) — "to judge, evaluate, condemn"
...
**Key Greek:**
- αἰτέω (aiteō) — "ask" (present imperative: keep asking)
- ζητέω (zēteō) — "seek" (keep seeking)
- κρούω (krouō) — "knock" (keep knocking)
...
**Key Greek:**
- πλατεῖα (plateia) — "wide, broad"
- στενή (stenē) — "narrow, compressed"
...
**Key Greek:** καρπός (karpos) — "fruit" (evidence of inner nature)
...
**Key Greek:**
- φρόνιμος (phronimos) — "wise, sensible, prudent"
- μωρός (mōros) — "foolish, stupid" (root of English "moron")
