...
**Key Greek:**
- ἀπολύω (apolyō) — "to release, divorce, send away"
- πορνεία (porneia) — "sexual immorality, fornication"
- εὐνοῦχος (eunouchos) — "eunuch, celibate person"
...
**Key Greek:**
- ἀγαθός (agathos) — "good"
- τέλειος (teleios) — "complete, perfect, mature"
- θησαυρός (thēsauros) — "treasure, treasury"
...
- τρύπημα (trypēma) — "hole, eye (of needle)"
...
**Key Greek:**
- παλιγγενεσία (palingenesia) — "regeneration, renewal, rebirth"
- ἑκατονταπλασίονα (hekatontaplasiona) — "hundredfold"
- ἔσχατοι (eschatoi) — "last ones"
