...
**Key Greek:** ἐξουσία (exousia) — "authority, power, jurisdiction"
...
**Key Greek:**
- πρόβατα (probata) — "sheep" (vulnerable, defenseless)
- λύκοι (lykoi) — "wolves" (predators, killers)
...
**Key Greek:** φοβέω (phobeō) — "to fear, be afraid"
...
**Key Greek:** ὁμολογέω (homologeō) — "to confess, acknowledge publicly"
...
**Key Greek:** μάχαιρα (machaira) — "sword" (not peace, but division)
