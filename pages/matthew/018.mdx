...
- ταπεινόω (tapeinoō) — "to humble, make low"
...
- μύλος ὀνικός (mylos onikos) — "millstone turned by donkey"
...
- πλανάω (planaō) — "to wander, go astray"
...
**Key Greek:**
- ἐλέγχω (elegchō) — "to reprove, expose, correct"
...
**Key Greek:**
- ἀφίημι (aphiēmi) — "to forgive, cancel, release"
- ταλάντον (talanton) — "talent" (75 lbs of silver)
