...
**Key Greek:**
- γενέσεως (geneseōs) — "genealogy, origin, genesis" (v. 1)
- γεννάω (gennaō) — "to father, beget, give birth" (used 39x in vv. 2-16)
...
**Key Greek:**
- μνηστευθείσης (mnēsteutheisēs) — "betrothed, pledged to be married" (v. 18)
- πνεῦμα ἅγιον (pneuma hagion) — "Holy Spirit" (v. 18, 20)
- παραλαβεῖν (paralabein) — "to take [as wife]" (v. 20, 24)
